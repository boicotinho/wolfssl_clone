...
enum Misc_ASN {
...
#endif
#if defined(WOLFSSL_CERT_EXT) ||  defined(HAVE_PKCS7)
    ...
    WOLFSSL_X509_V2     = 1,
    WOLFSSL_X509_V3     = 2,
#if  defined(WOLFSSL_NGINX) || defined(WOLFSSL_HAPROXY) || defined(HAVE_PKCS7)
...
#if defined(WOLFSSL_TEST_CERT) || defined(WOLFSSL_PUBLIC_ASN)
