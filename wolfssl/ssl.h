...
#if defined(HAVE_STUNNEL)  || defined(HAVE_LIGHTY)  || defined(WOLFSSL_HAPROXY)
...
#if defined(HAVE_STUNNEL) || defined(WOLFSSL_NGINX)  || defined(WOLFSSL_HAPROXY) || defined(HAVE_LIGHTY)
